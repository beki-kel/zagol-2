...
const FlightCard: FC<FlightCardProps> = ({ className = "", data }) => {
  ...
  return (
    <div
      className={`nc-FlightCardgroup p-4 sm:p-6 xl:px-2 xl:py-2 relative bg-white dark:bg-neutral-900 border border-neutral-100 dark:border-neutral-800 rounded-2xl overflow-hidden hover:shadow-lg transition-shadow space-y-3 ${className}`}
    >
      <div className={`sm:pr-20 xl:px-4 relative ${className}`}>
        {/*  eslint-disable-next-line jsx-a11y/anchor-has-content */}
        <a href="##" className="absolute inset-0" />
        <div className="flex flex-col">
          <div className="flex justify-center items-center border-b  w-full py-2 px-10">
            ...
            <div className="flex w-1/3 justify-end items-center -mr-4">
