...
const StaySearchForm: FC<{}> = ({}) => {
  const roomType = [
    { name: "Single Bed", href: "#" },
    { name: "king Bed", href: "#" },
    { name: "Double Bed", href: "#" },
    { name: "3 Beds", href: "#" },
    { name: "4+ Beds", href: "#" },
  ];
  const StarRating = [
  ...
  const renderSelectClass = () => {
    const [roomTypeState, setRoomTypeState] = useState("Bed Type");
                    ...
                    {ratingState.map((item, index) => (
                      ...
                      >
                        <input
                          ...
                          className="mr-2 checked:bg-[#2995D3] focus:checked:bg-[#2995D3] hover:checked:bg-[#2995D3]  rounded-md hover:ring-[#2995D3] focus:ring-[#2995D3]"
                        />
