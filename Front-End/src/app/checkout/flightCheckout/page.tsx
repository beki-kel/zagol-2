...
const PassengerDetailsModal: React.FC<PassengerDetailsModalProps> = ({
  ...
  const [formValues, setFormValues] = useState<PassengerDetails>({
    firstName: "",
    lastName: "",
    gender: "",
    dob: "",
  ...
  const paymentMethods = [
    {
      ...
      icon: faCreditCard,
      instructions:
        "Follow this steps to pay with commericial bank of ethiopia",
    },
    {
      id: "Tele Birr",
      name: "TeleBirr",
      icon: faCreditCard,
      instructions: "Follow this steps to pay with telebirr. ",
    },
    {
      id: "Awash Bank",
      name: "Awash Bank",
      icon: faCreditCard,
      instructions: "Follow this steps to pay with Awash Bank.",
    },
    {
      id: "Zemen Bank",
      name: "Zemen Bank",
      icon: faCreditCard,
      instructions: "Follow this steps to pay with Zemen Bank. ",
    },
  ];
      ...
      <div className="grid gap-4 mb-4 grid-cols-2">
        ...
        <div className="relative z-0 w-full mb-5 group col-span-2">
          <input
            ...
            className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-[#2995D3] focus:outline-none focus:ring-0 focus:border-[#2995D3] peer"
            placeholder=" "
            required
          />
          <label
        ...
        <div className="relative z-0 w-full mb-5 group col-span-2 sm:col-span-1">
          <select
            ...
            onChange={handleChange}
            className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:bg-gray-700 dark:border-gray-600 dark:focus:border-[#2995D3] focus:outline-none focus:ring-0 focus:border-[#2995D3] peer"
            required
          >
    ...
    >
      ...
      <div
        className={`relative p-4 ${
          step === 4 ? "max-w-md h-[55vh]" : "max-w-lg h-full"
        }`}
      >
