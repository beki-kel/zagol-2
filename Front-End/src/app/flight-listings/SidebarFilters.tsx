...
const SidebarFilters: React.FC<SidebarFiltersProps> = ({
  ...
  return (
    <div className=" bg-white dark:bg-neutral-900 rounded-2xl">
      <div className="py-4 rounded-lg flex flex-col bg-slate-50 dark:bg-slate-800 shadow-md justify-center items-center border-neutral-200 dark:border-neutral-700 mb-3">
      ...
      <div className=" p-4 rounded-lg bg-slate-50 dark:bg-slate-800 shadow-md justify-center items-center border-neutral-200 dark:border-neutral-700 mb-3 ">
