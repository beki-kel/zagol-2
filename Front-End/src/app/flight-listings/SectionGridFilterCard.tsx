...
import PassengerDetailsModal from "@/components/PassengerDetailsModal"; // Import the modal
...
const SectionGridFilterCard: FC<SectionGridFilterCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="lg:p-5 lg:bg-neutral-50 lg:dark:bg-black/20 flex flex-col space-y-4 justify-center items-center rounded-3xl">
        <div className="pb-3 border-b border-neutral-300 dark:border-neutral-800 flex justify-center">
          <OnTopDateSlider
            maxDays={30}
            daysToDisplay={10}
